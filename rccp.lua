...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "space", function () awful.layout.inc(-1)                end,
              {description = "select previous", group = "layout"}), --TODO
...
clientkeys = gears.table.join(
    awful.key({ modkey,           }, "f",
        function (c)
            if c.class ~= "plasmashell" then --TODO
...
client.connect_signal("property::floating", function (c)
    if c.floating and not(c.class == "plasmashell" or c.class == "krunner") then
